...
HINTERNET InternetConnectW( HINTERNET hInternet, LPCTSTR lpszServerName, INTERNET_PORT nServerPort, LPCTSTR lpszUsername, LPCTSTR lpszPassword, DWORD dwService, DWORD dwFlags,
                            DWORD_PTR dwContext );
HINTERNET HttpOpenRequestW( HINTERNET hConnect, LPCTSTR lpszVerb, LPCTSTR lpszObjectName, LPCTSTR lpszVersion, LPCTSTR lpszReferer, int /*LPCTSTR* */ lplpszAcceptTypes,
                            uint /*DWORD*/ dwFlags, DWORD_PTR dwContext );
...
public:
   ...
   // --- GET ---
   Response get( string url, string &arr_data[][] ) { return get( url, RequestData::to_str( arr_data ) ); }

   Response get( string url, RequestData &_request_data ) { return get( url, _request_data.to_str() ); }
   ...
   // --- POST ---
   Response post( string url, string &arr_data[][] ) { return post( url, RequestData::to_str( arr_data ) ); }

   Response post( string url, RequestData &_request_data ) { return post( url, _request_data.to_str() ); }
   ...
   // --- SEND (GET or POST) ---
   Response send( string method, string url, string &arr_data[][] ) { return send( method, url, RequestData::to_str( arr_data ) ); }

   Response send( string method, string url, RequestData &_request_data ) { return send( method, url, _request_data.to_str() ); }
